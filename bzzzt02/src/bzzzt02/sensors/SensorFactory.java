...
public class SensorFactory {
	...
	public BzzztSensor getSensor(String sensorType, String prefixTPFile, SensorManager sm, int sensorSubType){
		Log.d(TAG, "sensorTYPE: "+sensorType+" sm is !=null "+(sm!=null));
		if(sensorType == null){
			return null;
		}
		if(sensorType.equals(Constants.sensor_Accelerometer)){
			return new Accelerometer(prefixTPFile, sm, sensorSubType);
		}
		...
		if(sensorType.equals(Constants.sensor_Rotation)){
			Log.d(TAG, "sensorTYPE: "+sensorType+" sm is !=null "+(sm!=null));
			return new Rotation(prefixTPFile, sm, sensorSubType);
		}
		if(sensorType.equals(Constants.sensor_Gravity)){
			Log.d(TAG, "sensorTYPE: "+sensorType+" sm is !=null "+(sm!=null));
			return new Gravity(prefixTPFile, sm, sensorSubType);
		}
		return null;
	}
}
